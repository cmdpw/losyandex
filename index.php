        ...
        <table id="body" lang="ru">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div id="left">
                            <div class="b-region l-block"><span class="b-top-title  b-top-title_big">Добро пожаловать на ЛОСЯндекс! Лучший поисковик по миру смешариков!
                                </span>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td width="47%" class="c"><p><a href="secret.php">Тут секретик)</a>!
                </p>
 <td width="47%" class="c"><p><a href="https://losya.tatar/">Татарча Сайт</a>!
                </p>
                <p>
